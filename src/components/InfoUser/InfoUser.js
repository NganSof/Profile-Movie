    ...
    <div className="mt-40">
      <div className="text-center mt-10 text-lg font-bold text-red-300 font-mono grid grid-cols-2 md:grid sm:contents sm:mt-2 md:mt-10">
        <div className="col-span-1">
          <div className="w-96 flex justify-around px-4 bg-red-700 py-5 mb-5 ml-24 border-l-4 rounded-2xl border-red-900 hover:text-yellow-300 hover:border-red-700 hover:bg-green-700 shadow-xl sm:ml-3 md:ml-24 sm:w-56 md:w-96">
        ...
        <div className="col-span-1">
          <div className="w-96 flex justify-around px-4 bg-red-700 py-5 mb-5 ml-16 border-l-4 rounded-2xl border-red-900 hover:text-yellow-300 hover:border-red-700 hover:bg-green-700 shadow-xl sm:ml-3 md:ml-24 sm:w-56 md:w-96">
