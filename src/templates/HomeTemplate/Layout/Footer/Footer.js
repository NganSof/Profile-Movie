      ...
      <footer className="py-6 px-20 dark:bg-coolGray-800 dark:text-coolGray-50">
        <div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
            ...
            <div className="w-72 text-center md:text-left md:col-span-3 xl:text-center">
              ...
              <ul className="grid grid-cols-3 gap-2 sm:-ml-24 md:ml-0">
                {cluster?.map((logo, index) => {
                  return (
                    <li className="px-4">
                      <a href="/" className="px-12 hover:text-teal-400">
                        <div
                          key={index}
                          className="w-20 h-20 transform ease-in-out duration-300 hover:scale-105 hover:translate-x-1"
                          style={{
          ...
          <div className="flex justify-around items-center pt-12 lg:justify-between md:flex xl:w-full md:pl-0 md:py-5 sm:inline-block sm:py-4 sm:pl-0">
            ...
            <div className="w-1/2 flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13 sm:mt-10 sm:ml-10 md:my-0 md:mt-0">
              <a
                href="/"
                title="Email"
                className="flex mr-5 items-center justify-center w-10 h-10 rounded-full dark:bg-teal-400 dark:text-coolGray-900"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                  className="text-yellow-400 w-44 h-44 hover:text-red-800"
                >
